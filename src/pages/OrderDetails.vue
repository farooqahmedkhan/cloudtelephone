        ...
        <div class="seventh-1">
          <div class="p-7 text-center">
            ...
            <div class="my-8 text-left border px-4 py-3">
              ...
              <h4 class="text-xl font-normal text-primary">Billing Address: {{ order.billing_address1 }} /
                {{ order.billing_address2 }}</h4>
            ...
            <!-- unified products -->
            <table v-if="lead?.unifiedProducts"
            ...
            <!-- porting numbers -->
            <table v-if="lead?.portingNumbers"
              class="w-full  border border-neutral-200 text-left text-sm font-light mt-6">
              <tbody>
                <tr class="border-b border-neutral-200 bg-black/[0.02] dark:order-white/10 whitespace-nowrap">
                  <td colspan="4" class="px-6 py-4">
