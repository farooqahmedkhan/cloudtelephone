...
<template>
  <div>
      ...
      <div class="screen-3  pt-page current">
        <div class="key-feature-grid  grid p-7 text-center">
          ...
          <div class="key-feature-grid grid gap-7 sm:grid-cols-2 md:grid-cols-3 p-7">
            <button @click="stepNo = 2" class="mb-8 rounded-xl bg-theme-dark text-white py-5 px-5 shadow-lg">
              <h5 class="h5 text-white">Yes</h5>
              <p class="mt-4">See our range if devices</p>
            </button>
            <button @click="stepNo = 3" class="mb-8 rounded-xl bg-theme-dark text-white py-5 px-5 shadow-lg">
    ...
    <div v-else-if="stepNo == 2" class="screen-3-1 pt-page ">
      <div class="key-feature-grid  grid p-7 text-center">
        <h4 class="text-primary">Equipment</h4>
    ...
    <div v-else-if="stepNo == 3" class="screen-3-2 pt-page ">
    ...
    <div class="w-100 flex justify-between p-7">
      ...
      <button @click="onClickNext" class="btn btn-green mt-10 text-lg">Next</button>
    </div>
  </div>
</template>
